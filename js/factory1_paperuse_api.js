/* factory1_paperuse_api.js — 1공장 사용량 [1층] 데이터 연동
   ...
   별관(3공장)도 같은 형식의 v_factory3_usage_by_item 을 봅니다. 두 뷰의
   컬럼 구성이 같아 처리가 한 갈래로 끝납니다.
   ──────────────────────────────────────────────────────────────── */
(function () {
    'use strict';
    ...
    App.fetchRange = async function (from, to) {
        ...
        // 두 뷰 모두 이미 (날짜 × 품목)으로 합산돼 있어 그대로 담습니다.
        ...
        (f3Res.data || []).forEach(r => {
            ...
            state.factory3[r.print_date][r.item_code] = Number(r.usage_qty) || 0;
        });
