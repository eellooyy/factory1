/* factory1_ilji_main.js — 1공장 일지 진입점 · 헤더 초기화 · 이벤트 연결 */
(function () {
    'use strict';
    ...
    function initCalendar() {
        App.state.fp = flatpickr('#f1ilFlatpickr', {
            locale: 'ko',
            dateFormat: 'Y-m-d',
    ...
    const Factory1IljiModule = {
        init() {
            ...
            App.elements.dateText = document.getElementById('f1ilDateText');
            App.elements.prevBtn  = document.getElementById('f1ilPrevBtn');
            App.elements.nextBtn  = document.getElementById('f1ilNextBtn');
            App.elements.todayBtn = document.getElementById('f1ilTodayBtn');
            App.elements.editBtn  = document.getElementById('f1ilEditBtn');
            App.elements.saveBtn  = document.getElementById('f1ilSaveBtn');
            App.elements.excelBtn = document.getElementById('f1ilExcelBtn');
