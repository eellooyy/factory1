...
(function () {
    ...
    window.Factory1Narasarang = {
        ...
        /* ── 표를 넷으로 나눕니다 (3공장 재고 종합과 같은 구성) ──────────
             ① 날짜 · 입고 · 출고 · 지고 재고   완롤로 세는 자리
             ② B5 주행지 잔량 + 합계            사람이 적는 자리
             ③ 재고(kg)                         ①②에서 만들어지는 값
             ④ 출고(kg)                         ERP 에서 오는 값
           네 패널의 세로 스크롤은 묶여 있습니다. 한 줄이 네 표에 걸쳐 있으니
           따로 굴리면 같은 날짜가 어긋나 보이고, 그 순간 표가 거짓말을 합니다.
           패널마다 열 수가 다르므로 '빈 표' 문구의 colspan 도 같이 둡니다.
           ──────────────────────────────────────────────────────────── */
        PANEL_IDS: ['f1nsScroll1', 'f1nsScroll2', 'f1nsScroll3', 'f1nsScroll4'],
        BODY_IDS:  ['f1nsBody1',   'f1nsBody2',   'f1nsBody3',   'f1nsBody4'],
        PANEL_COLS: [4, 7, 1, 1],
